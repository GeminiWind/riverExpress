          ...
          <div class="single_category wow fadeInDown">
            <div class="archive_style_1">
             ...
             <paginate
                ...
                :per="4"
              >
                <li v-for="article in paginated('articles')">
                  <div class="business_category_left wow fadeInDown">
                    <ul class="fashion_catgnav">
                      <li>
                        <div class="catgimg2_container"> <router-link :to="{ name: 'article', params: { article: article.slug }}"><img alt="" :src=article.image /></router-link></div>
                        <h2 class="catg_titile"><router-link :to="{ name: 'article', params: { article: article.slug }}">{{ article.title }}</router-link></a></h2>
