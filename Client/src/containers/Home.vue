      ...
      <div class="col-lg-3 col-md-3 col-sm-3">
        <div class="content_middle_leftbar">
          <div class="single_category wow fadeInDown">
            ...
            <ul class="catg1_nav">
              <li>
                <div class="catgimg_container"> <a href="pages/single.html" class="catg1_img"><img alt="" src="../assets/images/292x150x1.jpg"></a></div>
                <h3 class="post_titile"><a href="pages/single.html">Vestibulum ut est augue, in varius</a></h3>
              </li>
              <li>
                <div class="catgimg_container"> <a href="pages/single.html" class="catg1_img"><img alt="" src="../assets/images/292x150x2.jpg"></a></div>
                <h3 class="post_titile"><a href="pages/single.html">Vestibulum ut est augue, in varius</a></h3>
              </li>
            </ul>
          </div>
      ...
      <div class="col-lg-6 col-md-6 col-sm-6">
        <div class="content_middle_middle">
          <slick ref="slick" :options="slick2">
            <div class="single_featured_slide"> <a href="pages/single.html"><img src="../assets/images/567x330x1.jpg" alt=""></a>
            ...
            <div class="single_featured_slide"> <a href="pages/single.html"><img src="../assets/images/567x330x2.jpg" alt=""></a>
              <h2><a href="#">Praesent vitae quam vitae arcu posuer 2</a></h2>
              <p>Nunc tincidunt, elit non cursus euismod, lacus augue ornare metus, egestas imperdiet nulla nisl quis mauris. Suspendisse a pharetra urna. Morbi dui lectus, pharetra nec elementum eget, vulput...</p>
            </div>
            <div class="single_featured_slide"> <a href="pages/single.html"><img src="../assets/images/567x330x3.jpg" alt=""></a>
      ...
      <div class="col-lg-8 col-md-8">
        <div class="content_bottom_left">
          <div class="single_category wow fadeInDown">
            ...
            <div class="business_category_left wow fadeInDown">
              <ul class="fashion_catgnav">
                <li>
                  <div class="catgimg2_container"> <a href="pages/single.html"><img alt="" src="../assets/images/390x240x1.jpg"></a> </div>
            ...
            <div class="business_category_right wow fadeInDown">
              <ul class="small_catg">
                <li>
                  <div class="media wow fadeInDown"> <a class="media-left" href="pages/single.html"><img src="../assets/images/112x112.jpg" alt="" width="112px" height="112px"></a>
            ...
            <div class="games_category">
              <div class="single_category">
                ...
                <ul class="fashion_catgnav wow fadeInDown">
                  <li>
                    <div class="catgimg2_container"> <router-link :to="{ name: 'article', params: { article: games[0].slug }}"><img alt="" :src=games[0].image></router-link> </div>
                    <h2 class="catg_titile"><router-link :to="{ name: 'article', params: { article: games[0].slug }}">{{ games[0].title }}</router-link></h2>
                ...
                <ul class="small_catg wow fadeInDown" v-for="(game,index) in games">
                  <li v-if="index >0 && index <3">
                    <div class="media"><router-link :to="{ name: 'article', params: { article: game.slug }}" class="media-left"><img :src=game.image alt="" width="112" height="112"> </router-link>
                      <div class="media-body">
                        <h4 class="media-heading"><router-link :to="{ name: 'article', params: { article: game.slug }}">{{ game.slug }} </router-link></h4>
            ...
            <div class="fashion_category">
              <div class="single_category">
                <div class="single_category wow fadeInDown">
                  ...
                  <ul class="fashion_catgnav wow fadeInDown">
                    <li>
                      <div class="catgimg2_container"> <router-link :to="{ name: 'article', params: { article: fashions[0].slug }}"><img alt="" :src="fashions[0].image" width="112px" height="112px"></router-link> </div>
                      <h2 class="catg_titile"><router-link :to="{ name: 'article', params: { article: fashions[0].slug }}">{{ fashions[0].title }}</router-link></h2>
                      <div class="comments_box"> <span class="meta_date">{{ fashions[0].created_at | moment("ddd, hA") }}</span> <span class="meta_comment"><a href="#">{{ fashions[0].comments.length }} Comments</a></span> <span class="meta_more"><router-link :to="{ name: 'article', params: { article: fashions[0].slug }}">Read More...</router-link></span> </div>
                      <p>{{ fashions[0].short_intro | substring(93) }} </p>
                    </li>
                  </ul>
                  <ul class="small_catg wow fadeInDown" v-for="(fashion, index) in fashions">
                    <li v-if="index >0 && index <3">
                      <div class="media wow fadeInDown"> <router-link :to="{ name: 'article', params: { article: fashion.slug }}" class="media-left"><img :src=fashion.image alt="" width="112px" height="112px"></router-link>
                        <div class="media-body">
                          <h4 class="media-heading"><router-link :to="{ name: 'article', params: { article: fashion.slug }}">{{ fashion.title }} </router-link></h4>
          ...
          <div class="technology_catrarea">
            <div class="single_category">
              <h2> <span class="bold_line"><span></span></span> <span class="solid_line"></span> <router-link :to="{ name: 'category', params: { category: 'Technology' }}" class="title_text">Technology</router-link> </h2>
              <div class="business_category_left">
                <ul class="fashion_catgnav wow fadeInDown">
                  <li>
                    <div class="catgimg2_container"><router-link :to="{ name: 'article', params: { article: technologies[0].slug }}"><img alt="" :src="technologies[0].image"></router-link> </div>
                    <h2 class="catg_titile"><router-link :to="{ name: 'article', params: { article: technologies[0].slug }}">{{ technologies[0].title }}</router-link></h2>
                    <div class="comments_box"> <span class="meta_date"> {{ technologies[0].created_at | moment("ddd, hA") }}</span> <span class="meta_comment"><a href="#">{{ technologies[0].comments.length }} Comments</a></span> <span class="meta_more"><router-link :to="{ name: 'article', params: { article: technologies[0].slug }}">Read More...</router-link></span> </div>
                    <div><p>{{ technologies[0].short_intro | substring(93) }}</p></div>
                  </li>
                </ul>
              </div>
              <div class="business_category_right">
                <ul class="small_catg wow fadeInDown" v-for="(technology, index) in technologies">
                  <li v-if="index > 0 && index < 4">
                    <div class="media wow fadeInDown"><router-link :to="{ name: 'article', params: { article: technology.slug }}" class="media-left"><img :src="technology.image" alt="" width="112px" height="112px"></router-link>
                      <div class="media-body">
                        <h4 class="media-heading"><router-link :to="{ name: 'article', params: { article: technology.slug }}">{{ technology.title }}</router-link></h4>
...
export default {
  ...
  methods: {
    async fetchByCategory(category) {
      try {
        const { data } = await this.$http.get(`/articles?category=${category}`);
        return data.data;
      } catch (error) {
